...
def gene_arg():
    ...
    parser.add_argument('--dataset', type=str, default="NCI1", help='dataset name (default: ogbg-code)')
    ...
    group.add_argument('--gamma', type=float, default=0.6)
    ...
    group.add_argument('--num_layers', type=int, default=4, help='number of GNN message passing layers (default: 5)')
    ...
    group.add_argument('--batch_size', type=int, default=128, help='input batch size for training (default: 128)')
    group.add_argument('--eval_batch_size', type=int, default=128, help='input batch size for training (default: train batch size)')
