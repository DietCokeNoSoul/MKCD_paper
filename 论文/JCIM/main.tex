...
\keywords{Multi-perspective node feature distribution encoding, Multi-scale hypergraph learning, Cross-attention propagation strategy, Multi-graph contrastive learning, Drug-related microbes prediction}
...
\begin{table}
    ...
    \hline
        \textit{p}-value  & SGFCCDA & MLNGCF & MDGF-MCEC & Bi-SGTAR & GraphCDA & MPCLCDA\\
    \hline
