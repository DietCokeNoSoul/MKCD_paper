...
class Net(nn.Module):
    def __init__(self):
        ...
        self.p1 = nn.MaxPool2d(kernel_size=(1, 4)) #
        ...
        self.l1 = nn.Linear(1088, 256) #全连接层
    ...
    def forward(self,x1,x2,features): # features:1527*1527 行为circRNA, disease, miRNA,列为circRNA, disease, miRNA
        ...
        x2 = x2 + 271
        x = torch.cat([features[x1][:,None,None,:], features[x2][:,None,None,:]], dim=2)     #两个特征按列拼接,x:32*1*2*489
